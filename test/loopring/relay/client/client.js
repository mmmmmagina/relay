...
var getOrderRequest = {pageIndex : 1, pageSize : 10, owner : "0xD091341B21758C34AedC95FD27699197dA71b782"};
client.request('loopring_getOrders', getOrderRequest, function(err, response) {
    if(err) throw err;
    console.log(response); // 5!
});