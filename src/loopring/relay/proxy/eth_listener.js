...
var EthListener = function () {
    this.web3 = null;
    this.contract = null;
};

EthListener.prototype.connect = function (connection) {
    if (!this.web3) {
...
EthListener.prototype.exec = function(method, args, callback) {
...
module.exports = new EthListener;